...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.game-btn').forEach(button => {
        button.addEventListener('click', function(){
            ...
            document.querySelector('.stock-img-l').src = `images/${stocks[randomLeft][1]}.png`;
            ...
            document.querySelector('.stock-img-r').src = `images/${stocks[randomRight][1]}.png`;
            ...
            document.querySelector('.next-btn').addEventListener('click', async function(){
                ...
                document.querySelector('.middle-circle').src = `images/vs.png`;
                ...
                if (currentScore == 0) {
                    ...
                    document.querySelector('.stock-para-l').textContent = textContent
                    document.querySelector('.stock-img-l').src = `images/${stocks[currentRight][1]}.png`;
                // if it is not the first round as score is 1 or more
                    ...
                    document.querySelector('.stock-para-l').textContent = textContent
                    document.querySelector('.stock-img-l').src = `images/${stocks[prevRight][1]}.png`;
                ...
                document.querySelector('.stock-para-r').textContent = textContent
                document.querySelector('.stock-img-r').src = `images/${stocks[nextRight][1]}.png`;
